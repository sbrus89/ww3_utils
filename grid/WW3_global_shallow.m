...
min_el    = 7e3;  	             % minimum resolution in meters.
bbox      = [-180 180; -88  82]; % lon min lon max; lat min lat max
max_el    = 300e3; 		         % maximum resolution in meters. 
wl        = 30;                  % 30 elements resolve M2 wavelength.
dt        = 0;                   % Only reduces res away from coast
grade     = 0.10                % mesh grade in decimal percent. 
R         = 3; 			         % Number of elements to resolve feature.
slp       = 10;                  % slope of 10

outname = 'Global_shallow_4000_edit'
cw_file = 'cellWidthVsLatLon_shallow_4000_edit.nc'

%% STEP 2: specify geographical datasets and process the geographical data
%% to be used later with other OceanMesh classes...
dem       = 'bathy_SSG_1_120.nc'; 
coastline = {'GSHHS_h_L1_edit','GSHHS_h_L6'};
